...
KANBAN_GUIDANCE = (
    ...
    "If your task produced user-facing files, images, videos, reports, or "
    "review sheets, pass their host-visible absolute paths in "
    "`kanban_complete(artifacts=[...])`; subscribed gateway chats upload "
    "those artifacts natively (for example, Telegram receives images/files "
    "instead of just path text). "
